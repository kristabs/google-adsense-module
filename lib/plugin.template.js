    ...
    return h(
      'ins',
      {
        ...
        attrs: {
          ...
          'data-matched-content-rows-num': this.matchedContentRowsNum || null,
          'data-matched-content-columns-num': this.matchedContentColumnsNum || null,
          'data-matched-content-ui-type': this.matchedContentUiType || null
        },
        domProps: {
          innerHTML: this.show ? '' : ' '
        },
